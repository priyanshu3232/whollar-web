/* UMBRELLA COPY. This file is home/js/join-welcome.js, deployed at whollar.ca.
 * It differs from js/join-welcome.js in one way: every product link is absolute
 * to internet.whollar.ca, because the product is a different host now.
 *
    ...
    internet: {
      ...
      steps: [
        { k: 'STEP 1', h: 'Build the bid on your real bill',
          ...
          link: 'Run the checkup', href: 'https://internet.whollar.ca/bill-checkup' },
    ...
    tires: {
      ...
      steps: [
        { k: 'STEP 1', h: 'Tell us what your car needs',
          ...
          link: 'Add my vehicle', href: 'https://internet.whollar.ca/dashboard' },
